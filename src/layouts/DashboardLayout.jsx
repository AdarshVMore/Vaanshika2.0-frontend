      ...
      <div className="flex h-screen overflow-hidden">
            ...
            >
              <div className="p-4 border-b border-white border-opacity-20 flex items-center justify-between">
                ...
                >
                  ...
                  {isSidebarOpen && (
                    <h2 className="text-xl font-bold bg-gradient-to-r from-primary-600 to-secondary-500 bg-clip-text text-transparent m-2">
                      Vaanshika
                    </h2>
                  )}
                </Link>
                <button
                  className="pr-2 rounded-full hover:bg-white hover:bg-opacity-20 transition-colors"
                  onClick={toggleSidebar}
                  aria-label={
        ...
        >
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link to="/profile">
                  <div className="flex items-center cursor-pointer">
                    <div className="avatar-sm mr-2 bg-primary-100 rounded-full flex items-center justify-center text-primary-700 text-lg font-bold">
          ...
          <footer className="glass-effect-light p-4 text-center text-sm text-gray-600 dark:text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Vaanshika. All rights reserved.
            </p>
          </footer>
        </main>
      </div>
